...
simpleRandomInit seed = (z, w) where
...
fibos :: [Int]
fibos = 0 : 1 : fst (rodaCom fibos' (0, 1))
...
fibos' :: ST (Int, Int) [Int]
fibos' = mapM constNextFibo [1..]
-- mapM :: (Traversable t, Monad m) => (a -> m b) -> t a -> m (t b)

-------------------------------------------------

-- const :: a -> b -> a
constNextFibo :: a -> ST (Int, Int) Int
constNextFibo = const nextFibo

-- state transformer de um passo
nextFibo :: ST (Int, Int) Int
